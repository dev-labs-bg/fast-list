...
```
That's it! The first parameter is the list you want to show, the second is a function for binding each element. It uses Kotlin Extensions, so you can directly address the XML views and set them up.
